...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      ref={contactRef}
      className="min-h-screen flex items-center py-12 sm:py-20 bg-black px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          <motion.h1
            className="text-3xl sm:text-4xl md:text-5xl font-black mb-2 sm:mb-4 bg-gradient-to-r from-blue-500 via-blue-300 to-cyan-300 bg-clip-text text-transparent"
