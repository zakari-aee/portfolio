        ...
        >
            <div className="max-w-4xl mx-auto w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    {/* Card 1 */}
                    <motion.div
                        className="bg-gray-900/50 rounded-2xl p-4 sm:p-6 border border-gray-800 shadow-xl shadow-purple-900/20 backdrop-blur-sm"
                        initial={{ opacity: 0, y: 20 }}
                        animate={isVisible ? { opacity: 1, y: 0 } : {}}
                        transition={{ duration: 0.8, delay: 0.6 }}
                    >
                        <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                            <IconBox colorClass="bg-purple-500/20">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-2 sm:gap-3 p-3 bg-black/30 rounded-xl hover:bg-gray-800/50 transition-colors border border-gray-800 hover:border-purple-500/30">
                                <IconBox colorClass="bg-purple-500/20">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <a
                                        ...
                                        className="text-white font-semibold hover:text-purple-400 transition-colors flex items-center gap-1 sm:gap-2 truncate group"
                                    >
                                        {contactInfo.email}
                                        <ExternalLink className="w-3 h-3 sm:w-4 sm:h-4 text-purple-500 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" />
                                    </a>
                                </div>
                            </div>

                            <div className="flex items-center gap-2 sm:gap-3 p-3 bg-black/30 rounded-xl border border-gray-800">
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 p-3 bg-black/30 rounded-xl border border-gray-800">
                                <IconBox colorClass="bg-gradient-to-br from-purple-500/20 to-blue-500/20">
                        ...
                        <div className="mt-4 sm:mt-6 pt-4 border-t border-gray-800">
                            ...
                            <div className="space-y-1 sm:space-y-2">
                                {officeHours.map((schedule, index) => (
                                    <div key={index} className="flex justify-between items-center py-1 sm:py-2 border-b border-gray-800 last:border-b-0 text-xs sm:text-sm">
                    ...
                    {/* Card 2 */}
                    <motion.div
                        className="bg-gray-900/50 rounded-2xl p-4 sm:p-6 border border-gray-800 shadow-xl shadow-blue-900/20 backdrop-blur-sm"
                        initial={{ opacity: 0, y: 20 }}
                        animate={isVisible ? { opacity: 1, y: 0 } : {}}
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            <motion.a
                                ...
                                className="flex items-center gap-2 sm:gap-3 p-3 bg-black/30 rounded-xl hover:bg-gray-800/50 transition-all group border border-gray-800 hover:border-purple-500/30 text-xs sm:text-sm"
                                whileHover={{ x: 3 }}
                            >
                                <IconBox colorClass="bg-gray-800">
                                    <Github className="w-5 h-5 sm:w-6 sm:h-6 text-white group-hover:text-purple-400" />
                                </IconBox>
                                <div className="flex-1 min-w-0">
                                    <p className="text-gray-400 mb-0.5">GitHub</p>
                                    <p className="text-white font-semibold truncate">View my projects and code</p>
                                </div>
                                <ExternalLink className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 group-hover:text-purple-400 transition-colors flex-shrink-0" />
                            </motion.a>
                            ...
                            <motion.a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-2 sm:gap-3 p-3 bg-black/30 rounded-xl hover:bg-gray-800/50 transition-all group border border-gray-800 hover:border-blue-500/30 text-xs sm:text-sm"
                                whileHover={{ x: 3 }}
                            >
                                <IconBox colorClass="bg-blue-500/20">
                            ...
                            <motion.a
                                href={`mailto:${contactInfo.email}`}
                                className="flex items-center gap-2 sm:gap-3 p-3 bg-black/30 rounded-xl hover:bg-gray-800/50 transition-all group border border-gray-800 hover:border-gradient-to-br hover:from-purple-500/30 hover:to-blue-500/30 text-xs sm:text-sm"
                                whileHover={{ x: 3 }}
                            >
                                <IconBox colorClass="bg-gradient-to-br from-purple-500/20 to-blue-500/20">
                                    <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-blue-400" />
                        ...
                        <div className="mt-4 sm:mt-6 pt-4 border-t border-gray-800">
                            <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 rounded-xl p-3 sm:p-4 border border-purple-500/30 text-xs sm:text-sm">
                            ...
                            <div className="mt-3 flex items-center gap-2 sm:gap-3 text-blue-400 bg-blue-900/30 rounded-xl p-3 sm:p-4 border border-blue-800/50 text-xs sm:text-sm">
