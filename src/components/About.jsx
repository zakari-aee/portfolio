            ...
            <div className="relative z-10 w-screen left-[50%] right-[50%] -ml-[50vw] -mr-[50vw] px-6 md:px-12 lg:px-24">
                ...
                >
                    ...
                    <p className="text-neutral-500 text-sm leading-relaxed max-w-md font-light mx-auto">
                        Full-stack engineer focused on scalable architecture and clean system design.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
                    ...
                    >
                        <h3 className="text-3xl font-light mb-6 leading-relaxed">
                            I build <span className="font-bold">robust & scalable</span> applications
                            that solve real-world problems.
                        </h3>

                        <p className="text-neutral-400 text-base leading-relaxed mb-6 font-light">
                            With 5+ years of full-stack development experience, I design and build
                            complete systems across frontend, backend, and database layers.
                            My focus is performance, maintainability, and scalability.
                        </p>

                        <p className="text-neutral-500 text-sm leading-relaxed font-light mb-10">
                            I work mainly with modern JavaScript ecosystems, Laravel backends,
                            and relational databases. Based in Meknes, Morocco, I enjoy system
                            architecture, clean code, and building products that matter.
                        </p>

                        <motion.a
                            href="#projects"
                            className="inline-flex items-center gap-3 text-[11px] font-bold uppercase tracking-widest text-neutral-500 hover:text-white transition-colors"
                            whileHover={{ x: 6 }}
                        >
