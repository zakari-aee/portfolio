...
import { Github, ExternalLink, Terminal, Layout, Cpu, Globe, Monitor } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    >
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-[10px] font-bold tracking-[0.4em] uppercase text-neutral-500">Works // 03</span>
                        </div>
                        ...
                        <p className="text-neutral-500 text-sm leading-relaxed max-w-[220px] font-light">
                            Showcasing technical architecture and specialized software deployments.
                        </p>
                    </motion.div>
                            ...
                            >
                                <div className="grid grid-cols-1 xl:grid-cols-2">
                                    ...
                                    <div className="p-10 md:p-14 flex flex-col justify-between">
                                        <div>
                                            <div className="flex items-center gap-3 mb-6">
                                                <span className="text-[10px] font-mono text-neutral-600">{project.id}</span>
                                            ...
                                            <div className="flex flex-wrap gap-2 mb-10">
                                                {project.tags.map(tag => (
                                                    <span key={tag} className="px-4 py-1.5 bg-white/5 border border-white/5 rounded-full text-[10px] font-bold text-neutral-500 uppercase">
                                                        {tag}
                                                    </span>
                                                ))}
                                            </div>
                                        ...
                                        <div className="flex gap-4">
                                            <a href="#" className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest hover:text-white text-neutral-500 transition-colors group/link">
                                    ...
                                    <div className="relative h-[300px] xl:h-auto overflow-hidden bg-neutral-900 border-l border-white/5">
                                        <div className={`absolute inset-0 bg-gradient-to-br ${project.color} to-transparent z-10 opacity-60 group-hover:opacity-20 transition-opacity duration-700`} />
                                        <img 
                                            src={project.image} 
                                            alt={project.title}
